        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row g-1 d-flex justify-content-center margin-row">
                    <div class="col-3">
                        <label for="supplierlihat" class="col-form-label">Supplier</label>
                    </div>
                    <div class="col-7">
                ...
                <div class="row g-1 d-flex justify-content-center margin-row">
                    <div class="col-3">
                        <label for="tanggallihat" class="col-form-label">Tanggal Pembelian</label>
                    </div>
    ...
    $('#Lihatpembelian').on('show.bs.modal', function(e) {
        ...
        $.ajax({
            ...
            `;
                ...
                $('#supplierlihat').val(response.detail[0].id_supplier);
                var tanggalAwal = response.detail[0].tanggal_pembelian;
