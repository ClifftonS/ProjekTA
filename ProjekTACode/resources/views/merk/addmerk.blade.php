<div class="modal fade" id="Addmerk" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title w-100 text-center" id="exampleModalLabel">Tambah Merk
                </h5>
            ...
            <div class="modal-body">
                ...
                <div class="d-flex justify-content-center mb-4">
                    ...
                    <input type="submit" id="addmerk" class="btn shadow rounded"
...
<script>
    ...
    $('#Addmerk').on('hidden.bs.modal', function() {
        $('#namaadd').val("");
        $('#alert-namaadd').removeClass('d-block');
        $('#alert-namaadd').addClass('d-none');
    });
